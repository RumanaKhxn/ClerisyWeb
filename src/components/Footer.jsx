...
const Footer = () => {
  return (
    <footer className="relative bg-[#385399] text-white py-6 sm:py-8 md:py-10 w-full overflow-hidden">
      <div className="max-w-7xl mx-auto relative px-4 sm:px-6 md:px-8 lg:px-10">

        {/* 🔹 Contact Info Row */}
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 text-center justify-center items-center mb-6">
          {/* Phone */}
          <div>
            <p className="flex items-center justify-center sm:justify-start text-sm sm:text-base md:text-lg">
              <svg
          ...
          {/* Email */}
          <div>
            <p className="flex items-center justify-center sm:justify-start text-sm sm:text-base md:text-lg break-all sm:break-normal">
              <svg
                className="w-4 h-4 md:w-5 md:h-5 mr-2 flex-shrink-0"
                fill="currentColor"
                viewBox="0 0 16 16"
          ...
          {/* Address */}
          <div>
            <p className="flex items-center justify-center lg:justify-start text-sm sm:text-base md:text-lg">
              <svg
                className="w-4 h-4 md:w-5 md:h-5 mr-2 flex-shrink-0"
                fill="currentColor"
                viewBox="0 0 16 16"
              ...
              101-20 Lefferts Blvd, NY 11419
            </p>
          </div>
        </div>

        {/* 🔹 Top full-width border */}
        <div className="w-screen border-t border-white/20 relative left-1/2 right-1/2 -translate-x-1/2 mb-6"></div>

        {/* 🔹 Main Footer Section */}
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 items-start mb-6">
          {/* Logo + Info */}
          <div className="text-center sm:text-left">
            <div className="w-28 sm:w-32 mb-4 mx-auto sm:mx-0">
              <img
      ...
      >
        <path d={icon.path} />
            ...
            <div className="space-y-1">
              <a
                href="#"
                className="block text-sm sm:text-base hover:text-white/80"
              >
                Privacy Policy
              </a>
              <a
          ...
          <div className="text-center sm:text-left lg:text-right">
            ...
            <ul className="space-y-2">
              {["Primary Care", "Specialty Care", "Diagnostic Services"].map(
                (service) => (
                  <li key={service}>
                    <a
                      href="#"
                      className="text-sm sm:text-base hover:text-white/80 transition duration-200 hover:-translate-x-1 lg:hover:translate-x-1 block"
                    >
                      {service}
                    </a>
                  </li>
        ...
        <div className="w-screen border-t border-white/20 relative left-1/2 right-1/2 -translate-x-1/2 mb-4"></div>
      </div>

      {/* 🔹 Copyright */}
      <div className="text-center px-4">
        <p className="text-white/80 text-sm sm:text-base">
          © {new Date().getFullYear()} Clerisy Medical PC. All rights reserved.
        </p>
      </div>
    </footer>
  );
