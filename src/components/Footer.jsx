    ...
    >
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 text-center justify-center items-center mb-6 w-full">
        ...
        <div className="flex justify-center">
          <p className="flex items-center text-sm sm:text-base md:text-lg">
            <svg
        ...
        {/* Email - Centered */}
        <div className="flex justify-center">
          <p className="flex items-center text-sm sm:text-base md:text-lg break-all sm:break-normal">
            <svg
              className="w-4 h-4 md:w-5 md:h-5 mr-2 flex-shrink-0"
              fill="currentColor"
              viewBox="0 0 16 16"
      ...
      {/* 🔹 Top full-width border - Centered */}
      <div className="w-full border-t border-white/20 mb-6"></div>

      {/* 🔹 Main Footer Section - Fixed Center Alignment */}
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 items-start mb-6 w-full">
        {/* Logo + Info - Centered */}
        <div className="text-center flex flex-col items-center sm:items-center">
          <div className="w-28 sm:w-32 mb-4">
            <img
              src="/Clerisy-Medical-Logo.svg"
              alt="Clerisy Medical Logo"
              className="w-full h-auto bg-white rounded mx-auto"
              loading="lazy"
            />
          </div>

          <p className="text-white/90 text-sm sm:text-base md:text-lg mb-4">
            Providing quality healthcare <br/>services for over 20 years.
          </p>
        ...
        <div className="text-center flex flex-col items-center">
          ...
          <ul className="space-y-2">
            {["About Us", "Our Services", "Appointments", "Contact"].map((link) => (
              <li key={link}>
                <a
                  href="#"
        ...
        <div className="text-center flex flex-col items-center">
          ...
          <ul className="space-y-2">
            {["Primary Care", "Specialty Care","Emergency Care", "Diagnostic"].map(
              (service) => (
                <li key={service}>
                  <a
                    href="#"
      ...
      {/* 🔹 Bottom full-width border - Centered */}
