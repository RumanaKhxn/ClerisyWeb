...
const Treatment = () => {
  return (
    <section className="relative bg-white py-16 sm:py-20 md:py-20 lg:py-20 px-4 sm:px-6 md:px-8 lg:px-12 xl:px-20 overflow-hidden">
      <div className="max-w-6xl mx-auto">
        {/* Header Section - Fixed styling */}
        <div className="text-center mb-1 md:mb-5 lg:mb-4">
